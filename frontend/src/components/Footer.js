      ...
      <div className="footer-content">
        ...
        <div className="footer-column">
          ...
          <p className="column-text">
            NeuroLXP LMS provides a holistic and future-ready learning environment, 
            catering to diverse educational needs and fostering growth in the digital age.
          </p>
          <button className="start-btn">Why Wait. Let's Start</button>
          <div className="social-icons">
            {/* <div className="icon-box"><img src="/logo-placeholder.png" alt="logo" className="small-logo" /></div> */}
