  ...
  return (
    <header className="header">
      ...
      <nav className={`nav ${mobileOpen ? "mobile-open" : ""}`}>
        ...
        >
          Features
          <span className={`arrow ${activeMenu==="features" ? "rotate" : ""}`}>▾</span>
        ...
        >
          Use Cases
          <span className={`arrow ${activeMenu==="usecases" ? "rotate" : ""}`}>▾</span>
        ...
        >
          Our Customers
          <span className={`arrow ${activeMenu==="customers" ? "rotate" : ""}`}>▾</span>
        ...
        >
          Resources
          <span className={`arrow ${activeMenu==="resources" ? "rotate" : ""}`}>▾</span>
        ...
        >
          NeuroLabs
          <span className={`arrow ${activeMenu==="neurolabs" ? "rotate" : ""}`}>▾</span>
        ...
        >
          NeuroLXP 2.10
          <span className={`arrow ${activeMenu==="neurolxp" ? "rotate" : ""}`}>▾</span>
